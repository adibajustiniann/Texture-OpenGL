...
// NIM	: 24060120130080
// Praktikum GKV B1
// Tugas 5 Praktikum GKV 
// Membuat setiap sisi kubus memiliki texture yang berbeda.
...
void initRendering() 
{
	...
	Image* img1 = loadBMP("texture 1.bmp");
	_sisi1Id = loadTexture(img1);
	delete img1;

	Image* img2 = loadBMP("texture 2.bmp");
	_sisi2Id = loadTexture(img2);
	delete img2;

	Image* img3 = loadBMP("texture 3.bmp");
	_sisi3Id = loadTexture(img3);
	delete img3;

	Image* img4 = loadBMP("texture 4.bmp");
	_sisi4Id = loadTexture(img4);
	delete img4;

	Image* img5 = loadBMP("texture 5.bmp");
	_sisi5Id = loadTexture(img5);
	delete img5;

	Image* img6 = loadBMP("texture 6.bmp");
